...
from app.api.v1.sku_mappings import router as sku_mappings_router
...
api_v1_router.include_router(tiktok_router)
api_v1_router.include_router(sku_mappings_router)
